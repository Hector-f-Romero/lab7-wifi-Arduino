...
CREATE TABLE IF NOT EXISTS photocell_records (id_record INT PRIMARY KEY AUTO_INCREMENT,number_leds int NOT NULL, created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP);
